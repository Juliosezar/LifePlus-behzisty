...
urlpatterns = [
    ...
    path('case/<int:pk>/archive/', views.CaseArchiveView.as_view(), name='case_archive'),
    path('case/<int:pk>/unarchive/', views.CaseUnarchiveView.as_view(), name='case_unarchive'),
